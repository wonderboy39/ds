...
> R은 L이 구분해놓은 P보다 작은 그룹의 가장 마지막 요소의 인덱스를 가리키고 있고, L은 R(P보다 큰 그룹)의 첫 요소를 가리키고 있다.  
>  
> ##### Step 7)
> 1 3 2 4 5 8 6 7  
> P-------R L----  
...
> Step 6)에서 **R의 인덱스가 가리키던 요소(소그룹 L의 가장 마지막 요소)** 와  **P가 가리키는 요소를** swap한다.  
> 이렇게 하는 논리적 의미는 P(피봇)이 소그룹 L에서 가장 큰 요소 라는 것을 함축적으로 표현하는 것이다.  
>  
> ##### Step 8)
> 1 3 2 4 5 8 6 7  
> P-------R L----  
