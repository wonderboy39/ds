...
//		h.insertHeapNode(new HeapNode(3));
		...
		h.insertHeapNode2(new HeapNode(9));
		h.insertHeapNode2(new HeapNode(7));
		h.insertHeapNode2(new HeapNode(6));
		h.insertHeapNode2(new HeapNode(4));
		h.insertHeapNode2(new HeapNode(5));
		h.insertHeapNode2(new HeapNode(3));
		h.insertHeapNode2(new HeapNode(2));
		h.insertHeapNode2(new HeapNode(2));
		h.insertHeapNode2(new HeapNode(1));
		h.insertHeapNode2(new HeapNode(3));
		h.printHeapNodes();
